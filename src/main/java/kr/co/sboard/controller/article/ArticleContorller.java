...
public class ArticleContorller {
    ...
    public String list(Model model, PageRequestDTO pageRequestDTO) {
        ...
        log.info("testdebug_ pageResponseDTO.dtoList : " + pageResponseDTO.getDtoList());

        log.info("testdebug_ pageResponseDTO cate  : " + pageResponseDTO.getCate());
    ...
    public String view(Model model, int no) {
        ArticleDTO article = articleService.findByNo(no);
